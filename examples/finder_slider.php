<?php
    ...
    require_once ('../src/FinderManager.php');
    ...
    class SampleForm extends Form
    {
        ...
        protected Q\Plugin\FinderManager $objManager;
        ...
        protected function formCreate(): void
        {
            ...
            $this->objManager = new Q\Plugin\FinderManager($this);
        ...
        public function CreateButtons(): void
        {
            ...
            $this->btnInsert->addAction(new Q\Event\Click(), new Ajax('btnInsert_Click'));
            ...
            $this->btnCancel->addAction(new Q\Event\Click(), new Ajax('btnCancel_Click'));
        }
        ...
        /**
         * Handles the click event for the "Insert" button. This method processes input data, updates the locking status of files,
         * and inserts new entries into the "sliders" table. If the files are locked, it prevents insertion and shows a modal dialog box.
         *
         * @param ActionParams $params Input parameters associated with the "Insert" button click action.
         *
         * @return void This method does not return any value.
         * @throws Caller
         * @throws InvalidCast
        ...
        /**
         * Handles the click event for the cancel button. This method redirects the user to the 'slider_edit.php' page
         * and clears the session variable used for storing the finder ID.
         *
         * @param ActionParams $params The parameters passed to the action, typically including request data or form
         *     inputs.
         *
         * @return void This method does not return a value.
         * @throws Throwable
